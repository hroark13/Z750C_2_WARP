...
static char tianma_hx8369a02_ips_para_0xB2[3]= {0xB2,0x00,0x10,};

static char tianma_hx8369a02_ips_para_0xB4[6]= {0xB4,0x00,0x1d,0x80,0x00,0x00,};

static char tianma_hx8369a02_ips_para_0xB6[3]= {0xB6,0x4D,0x4D,};

static char tianma_hx8369a02_ips_para_0x36[2]= {0x36,0x10,};

static char tianma_hx8369a02_ips_para_0xD5[27]= {0xD5,0x00,0x01,0x03,0x7D,0x01,0x15,0x00,0x70,0x11,0x13,0x00,0x00,0x60,0x04,0x71,0x05,0x00,0x00,0x71,0x05,0x60,0x04,0x07,0x0F,0x04,0x04,};
...
static char tianma_hx8369a02_ips_para_0xBA[14]= {0xBA,0x00,0xA0,0xC6,0x00,0x0A,0x00,0x10,0x30,0x6F,0x02,0x11,0x18,0x40,};
...
static int mipi_get_manufacture_icid(struct msm_fb_data_type *mfd)
{
	...
	{	lcd_panle_reset();	
		...
		mipi_dsi_cmds_rx(&lead_tx_buf, &lead_rx_buf, mipi_manufacture_icid[i].readid_rx,mipi_manufacture_icid[i].readid_len_rx);
...
static uint32 mipi_get_commic_panleid(struct msm_fb_data_type *mfd,struct dsi_cmd_desc *para,uint32 len,int mode)
{
	...
	if(mode)
		...
		mipi_set_tx_power_mode(0);
	mipi_dsi_cmds_rx(&lead_tx_buf, &lead_rx_buf, para,len);
	if(mode)
		mipi_set_tx_power_mode(0);
...
/* [ECID:0000] ZTEBSP wangbing start 201205281 for lcd, start*/
if (0) {
	mipi_dsi_cmds_tx(&lead_tx_buf, display_off_cmds,  //yaotierui for JB
...
/*	mipi_dsi_cmds_tx(&lead_tx_buf, display_off_deep_cmds,
  ...
  printk("wangminrong lcd off\r\n");  
	...
	switch(LcdPanleID){
		...
		case (u32)LCD_PANEL_4P5_OTM8009A_JDF:
				mipi_dsi_cmds_tx(&lead_tx_buf, otm8009a_jdf_display_on_cmds,ARRAY_SIZE(otm8009a_jdf_display_on_cmds));
				printk("otm8009a jingdongfang lcd  init ok !!\n");
			break;
		//wangminrong add tianma nt35512
		case (u32)LCD_PANEL_4P5_NT35512_TIANMA:
				mipi_dsi_cmds_tx(&lead_tx_buf, nt3511_tianma_display_on_cmds_2,ARRAY_SIZE(nt3511_tianma_display_on_cmds_2));
				printk("TIANMA NT35512 LCD init ok !!\n");
			break;
			//wangminrong add lead nt35512
		case (u32)LCD_PANEL_4P5_NT35512_LEAD:
				mipi_dsi_cmds_tx(&lead_tx_buf, nt3512_lead_display_on_cmds,ARRAY_SIZE(nt3512_lead_display_on_cmds));
				printk("LEAD NT35512 LCD init ok !!\n");
			break;
			//wangminrong add tianma ips
		case (u32)LCD_PANNEL_4P5_HX8369_TIANMA_IPS:
				mipi_dsi_cmds_tx(&lead_tx_buf, tianma_hx8369a02_ips,ARRAY_SIZE(tianma_hx8369a02_ips));
