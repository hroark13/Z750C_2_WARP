...
//[ECID:000000] ZTEBSP  liyeqing, 20121025 change for Mipi_clock 447M, start
#if (defined CONFIG_PROJECT_P825F01 ) || ( defined CONFIG_PROJECT_P865F01 )|| ( defined CONFIG_PROJECT_P865V30 ) ||defined ( CONFIG_PROJECT_P865V20)//liyeqing change 20121025
	/* regulator */
	{0x03, 0x01, 0x01, 0x00},
	/* timing   */			/*447M*/
...
printk("wangminrong the lcd is video_fwvga_pt\r\n");
	...
	pinfo.wait_cycle = 0;
	pinfo.bpp = 24;
//[ECID:000000] ZTEBSP wangminrong add the cts test fail 20120926 start 

	pinfo.lcdc.h_back_porch = 112;//100
	pinfo.lcdc.h_front_porch = 112;//100

//[ECID:000000] ZTEBSP wangminrong add the cts test fail 20120926 end
	pinfo.lcdc.h_pulse_width = 10;
	pinfo.lcdc.v_back_porch = 26;//26;//lead panel must use 26
	pinfo.lcdc.v_front_porch = 10;
	pinfo.lcdc.v_pulse_width = 10;
	pinfo.clk_rate = 447000000;//499000000;
