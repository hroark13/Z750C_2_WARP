...
static char r61408_truly_para_CABC_0xb9[5]={0xb9,0x01,0x7f,0x03,0x18};

static char r61408_truly_para_CABC_0xb9_on[5]={0xb9,0x01,0x7f,0x03,0x18};
static char r61408_truly_para_CABC_0xb9_off[5]={0xb9,0x00,0x7f,0x03,0x18};
...
{
	//printk("wangminrong lcd is reset---\r\n");
...
//[ECID:617001723914]ZTEBSP wangminrong modify the white screen off the backlight and reset 20120917 end for A20 taiwan
...
if(counter == 2)
{
 ...
 printk("wangminrong lcd two logo off the backlight  1111\r\n");  
	set_lcd_backlight_off(mfd,0);
  printk("wangminrong two logo lcd off\r\n");  
	 ...
	 else if(lcd_id_type==8)
	 {
		...
		if(current_lel==0)
	 	...
	 	else
	   	{
			...
			r61408_truly_para_CABC_0xb9_on[1]=0x01;
	      		r61408_truly_para_CABC_0xb9_on[2]=(8*current_lel-1);
			mipi_set_tx_power_mode(0);
