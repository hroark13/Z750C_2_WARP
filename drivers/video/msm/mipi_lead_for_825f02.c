...
*************************************/
static char nt35516_tianma_para1[6] = {0xF0,0x55,0xaa,0x52,0x08,0x00};	// Select CMD2, Page 0  
static char nt35516_tianma_para2[6] = {0xb0,0x05,0x05,0x05,0x05,0x05}; // vertical / horizontal porch of RGB interface
static char nt35516_tianma_para3[2] = {0x4c,0x10};
static char nt35516_tianma_para4[4] = {0xb1,0x71,0x06,0x00};
static char nt35516_tianma_para5[2] = {0xb6,0x00};
static char nt35516_tianma_para6[3] = {0xb7,0xff,0x55};
static char nt35516_tianma_para7[3] = {0xbc,0x00,0x00};	
static char nt35516_tianma_para8[7] = {0xc9,0x41,0x06,0x0d,0x3a,0x17,0x00};
static char nt35516_tianma_para9[6] = {0xf0,0x55,0xaa,0x52,0x08,0x01};
static char nt35516_tianma_para10[5] = {0xd0,0x0a,0x10,0x0d,0x0f};	
static char nt35516_tianma_para11[17] = {0xd1,0x00,0x00,0x00,0x4d,0x00,0xa2,0x00,0xd9,0x01,0x00,0x01,0x29,0x01,0x4b,0x01,0x79};	
static char nt35516_tianma_para12[17] = {0xd2,0x01,0x9e,0x01,0xd8,0x02,0x03,0x02,0x45,0x02,0x7d,0x02,0x7f,0x02,0xaf,0x02,0xe6};
static char nt35516_tianma_para13[17] = {0xd3,0x03,0x05,0x03,0x2c,0x03,0x47,0x03,0x6b,0x03,0x83,0x03,0xac,0x03,0xcd,0x03,0xf5};	
static char nt35516_tianma_para14[5] = {0xd4,0x03,0xf8,0x03,0xf8};	
static char nt35516_tianma_para15[17] = {0xd5,0x00,0x00,0x00,0x4d,0x00,0xa2,0x00,0xd9,0x01,0x00,0x01,0x29,0x01,0x4b,0x01,0x79};	
static char nt35516_tianma_para16[17] = {0xd6,0x01,0x9e,0x01,0xd8,0x02,0x03,0x02,0x45,0x02,0x7d,0x02,0x7f,0x02,0xaf,0x02,0xe6};	
static char nt35516_tianma_para17[17] = {0xd7,0x03,0x05,0x03,0x2c,0x03,0x47,0x03,0x6b,0x03,0x83,0x03,0xac,0x03,0xcd,0x03,0xf5};	
static char nt35516_tianma_para18[5] = {0xd8,0x03,0xf8,0x03,0xf8};	
static char nt35516_tianma_para19[17] = {0xd9,0x00,0x00,0x00,0x4d,0x00,0xa2,0x00,0xd9,0x01,0x00,0x01,0x29,0x01,0x4b,0x01,0x79};	
static char nt35516_tianma_para20[17] = {0xdd,0x01,0x9e,0x01,0xd8,0x02,0x03,0x02,0x45,0x02,0x7d,0x02,0x7f,0x02,0xaf,0x02,0xe6};	
static char nt35516_tianma_para21[17] = {0xde,0x03,0x05,0x03,0x2c,0x03,0x47,0x03,0x6b,0x03,0x83,0x03,0xac,0x03,0xcd,0x03,0xf5};
static char nt35516_tianma_para22[5] = {0xdf,0x03,0xf8,0x03,0xf8};	
static char nt35516_tianma_para23[17] = {0xe0,0x00,0x00,0x00,0x4d,0x00,0xa2,0x00,0xd9,0x01,0x00,0x01,0x29,0x01,0x4b,0x01,0x79};	
static char nt35516_tianma_para24[17] = {0xe1,0x01,0x9e,0x01,0xd8,0x02,0x03,0x02,0x45,0x02,0x7d,0x02,0x7f,0x02,0xaf,0x02,0xe6};
static char nt35516_tianma_para25[17] = {0xe2,0x03,0x05,0x03,0x2c,0x03,0x47,0x03,0x6b,0x03,0x83,0x03,0xac,0x03,0xcd,0x03,0xf5};	
static char nt35516_tianma_para26[5] = {0xe3,0x03,0xf8,0x03,0xf8};	
static char nt35516_tianma_para27[17] = {0xe4,0x00,0x00,0x00,0x4d,0x00,0xa2,0x00,0xd9,0x01,0x00,0x01,0x29,0x01,0x4b,0x01,0x79};	
static char nt35516_tianma_para28[17] = {0xe5,0x01,0x9e,0x01,0xd8,0x02,0x03,0x02,0x45,0x02,0x7d,0x02,0x7f,0x02,0xaf,0x02,0xe6};	
static char nt35516_tianma_para29[17] = {0xe6,0x03,0x05,0x03,0x2c,0x03,0x47,0x03,0x6b,0x03,0x83,0x03,0xac,0x03,0xcd,0x03,0xf5};	
static char nt35516_tianma_para30[5] = {0xe7,0x03,0xf8,0x03,0xf8};	
static char nt35516_tianma_para31[17] = {0xe8,0x00,0x00,0x00,0x4d,0x00,0xa2,0x00,0xd9,0x01,0x00,0x01,0x29,0x01,0x4b,0x01,0x79};
static char nt35516_tianma_para32[17] = {0xe9,0x01,0x9e,0x01,0xd8,0x02,0x03,0x02,0x45,0x02,0x7d,0x02,0x7f,0x02,0xaf,0x02,0xe6};	
static char nt35516_tianma_para33[17] = {0xea,0x03,0x05,0x03,0x2c,0x03,0x47,0x03,0x6b,0x03,0x83,0x03,0xac,0x03,0xcd,0x03,0xf5};
static char nt35516_tianma_para34[5] = {0xeb,0x03,0xf8,0x03,0xf8};	
static char nt35516_tianma_para35[2] = {0xb0,0x0a};	
static char nt35516_tianma_para36[2] = {0xb6,0x34};	
static char nt35516_tianma_para37[2] = {0xb1,0x0a};	
static char nt35516_tianma_para38[2] = {0xb7,0x24};
static char nt35516_tianma_para39[2] = {0xb2,0x00};
static char nt35516_tianma_para40[2] = {0xb8,0x30};
static char nt35516_tianma_para41[2] = {0xb3,0x0a};
static char nt35516_tianma_para42[2] = {0xb9,0x24};
static char nt35516_tianma_para43[2] = {0xb4,0x0a};
static char nt35516_tianma_para44[2] = {0xba,0x34};
static char nt35516_tianma_para45[4] = {0xbc,0x00,0x78,0x00};
static char nt35516_tianma_para46[4] = {0xbd,0x00,0x78,0x00};
static char nt35516_tianma_para47[2] = {0xbe,0x44};
static char nt35516_tianma_para48[2] = {0xc2,0x00};
static char nt35516_tianma_para49[2] = {0x3a,0x77};
static char nt35516_tianma_para50[1] = {0x11};
//150ms
static char nt35516_tianma_para51[1] = {0x29};
//10ms

static struct dsi_cmd_desc nt35516_tianma_display_on_cmds[] = {
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para1), nt35516_tianma_para1},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para2), nt35516_tianma_para2},
{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35516_tianma_para3), nt35516_tianma_para3},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para4), nt35516_tianma_para4},
{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35516_tianma_para5), nt35516_tianma_para5},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para6), nt35516_tianma_para6},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para7), nt35516_tianma_para7},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para8), nt35516_tianma_para8},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para9), nt35516_tianma_para9},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para10), nt35516_tianma_para10},

{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para11), nt35516_tianma_para11},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para12), nt35516_tianma_para12},

{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para13), nt35516_tianma_para13},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para14), nt35516_tianma_para14},

{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para15), nt35516_tianma_para15},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para16), nt35516_tianma_para16},

{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para17), nt35516_tianma_para17},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para18), nt35516_tianma_para18},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para19), nt35516_tianma_para19},

{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para20), nt35516_tianma_para20},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para21), nt35516_tianma_para21},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para22), nt35516_tianma_para22},

{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para23), nt35516_tianma_para23},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para24), nt35516_tianma_para24},

{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para25), nt35516_tianma_para25},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para26), nt35516_tianma_para26},

{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para27), nt35516_tianma_para27},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para28), nt35516_tianma_para28},


{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para29), nt35516_tianma_para29},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para30), nt35516_tianma_para30},

{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para31), nt35516_tianma_para31},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para32), nt35516_tianma_para32},

{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para33), nt35516_tianma_para33},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para34), nt35516_tianma_para34},


{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35516_tianma_para35), nt35516_tianma_para35},
{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35516_tianma_para36), nt35516_tianma_para36},

{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35516_tianma_para37), nt35516_tianma_para37},
{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35516_tianma_para38), nt35516_tianma_para38},

{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35516_tianma_para39), nt35516_tianma_para39},
{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35516_tianma_para40), nt35516_tianma_para40},

{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35516_tianma_para41), nt35516_tianma_para41},
{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35516_tianma_para42), nt35516_tianma_para42},

{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35516_tianma_para43), nt35516_tianma_para43},
{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35516_tianma_para44), nt35516_tianma_para44},

{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para45), nt35516_tianma_para45},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(nt35516_tianma_para46), nt35516_tianma_para46},

{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35516_tianma_para47), nt35516_tianma_para47},
{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35516_tianma_para48), nt35516_tianma_para48},

{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(nt35516_tianma_para49), nt35516_tianma_para49},
{DTYPE_DCS_WRITE, 1, 0, 0, 150, sizeof(nt35516_tianma_para50), nt35516_tianma_para50},

{DTYPE_DCS_WRITE, 1, 0, 0, 10, sizeof(nt35516_tianma_para51), nt35516_tianma_para51},
...
//{DTYPE_DCS_WRITE, 1, 0, 0, 10, sizeof(display_on), display_on}
   ...
   static char para5[2] = {0x00,0x00};
     ...
     static char para67[2] = {0x00,0x80};	
      ...
      static char para118[2] = {0x36,0xD0};	
...
/*	mipi_dsi_cmds_tx(mfd, &lead_tx_buf, display_off_deep_cmds,
...
static int mipi_lcd_on(struct platform_device *pdev)
{
	...
	switch(LcdPanleID){
		...
		case (u32)LCD_PANEL_4P5_NT35516_TIANMA_QHD: //shihuiqin
				if(1)
				mipi_dsi_cmds_tx(mfd, &lead_tx_buf, nt35516_tianma_display_on_cmds,ARRAY_SIZE(nt35516_tianma_display_on_cmds));
		...
		case (u32)LCD_PANEL_4P5_OTM8009A_JDF:
				mipi_dsi_cmds_tx(mfd, &lead_tx_buf, otm8009a_jdf_display_on_cmds,ARRAY_SIZE(otm8009a_jdf_display_on_cmds));
		...
		case (u32)LCD_PANEL_4P5_OTM9608A_BOE_QHD:
			      if (1)
				mipi_dsi_cmds_tx(mfd, &lead_tx_buf, otm9608_video_init_cmds,ARRAY_SIZE(otm9608_video_init_cmds));
				printk("otm9608a BOE lcd  init ok !!\n");
			break;

		
		case (u32)LCD_PANEL_4P5_NT35512_TIANMA:
				mipi_dsi_cmds_tx(mfd, &lead_tx_buf, nt3511_tianma_display_on_cmds_2,ARRAY_SIZE(nt3511_tianma_display_on_cmds_2));
				printk("TIANMA NT35512 LCD init ok !!\n");
			break;
			//wangminrong add lead nt35512
		case (u32)LCD_PANEL_4P5_NT35512_LEAD:
				mipi_dsi_cmds_tx(mfd, &lead_tx_buf, nt3512_lead_display_on_cmds,ARRAY_SIZE(nt3512_lead_display_on_cmds));
