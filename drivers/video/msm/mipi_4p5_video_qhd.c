...
static char diplay_pixel_off[2] = {0x00,0x00};
static struct dsi_cmd_desc display_off_cmds[] = {
	{DTYPE_PERIPHERAL_OFF, 1, 0, 0, 10, sizeof(diplay_pixel_off), diplay_pixel_off},
...
static char otm9608a_para_CABC_0x51[2]={0x51,0xff};
static char otm9608a_para_CABC_0x53[2]={0x53,0x2c};
static char otm9608a_para_CABC_0x55[2]={0x55,0x00};
static struct dsi_cmd_desc otm9608a_display_on_no_CABC_backlight_cmds[] = {
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(otm9608a_para_CABC_0x51), otm9608a_para_CABC_0x51},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(otm9608a_para_CABC_0x53), otm9608a_para_CABC_0x53},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(otm9608a_para_CABC_0x55), otm9608a_para_CABC_0x55},
};
...
static char tianma_nt35516_para_CABC_0x51[2]={0x51,0xff};
static char tianma_nt35516_para_CABC_0x53[2]={0x53,0x2c};
static char tianma_nt35516_para_CABC_0x55[2]={0x55,0x00};
static struct dsi_cmd_desc tianma_nt35516_display_on_no_CABC_backlight_cmds[] = {
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(tianma_nt35516_para_CABC_0x51),tianma_nt35516_para_CABC_0x51},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(tianma_nt35516_para_CABC_0x53),tianma_nt35516_para_CABC_0x53},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(tianma_nt35516_para_CABC_0x55),tianma_nt35516_para_CABC_0x55},
};
...
#if 0
/*-------------liyeqing change 20121116 start -----------------*/
static char tianma_nt35516_qHD_para_0xF0[6]= {0xF0,0x55,0xAA,0x52,0x08,0x00,};
//static char tianma_nt35516_qHD_para_0xB1[4]= {0xB1,0x71,0x00,0x00,};
static char tianma_nt35516_qHD_para_0xB1[4]= {0xB1,0x7C,0x04,0x00,};
static char tianma_nt35516_qHD_para_0xB6[2]= {0xB6,0x0B,};
...
static char tianma_nt35516_qHD_para_0xBC[4]= {0xBC,0x04,0x00,0x00,};
static char tianma_nt35516_qHD_para_0xBB[4]= {0xBB,0x53,0x03,0x53,};
static char tianma_nt35516_qHD_para_0xC7[2]= {0xC7,0x70,};
//static char tianma_nt35516_qHD_para_0xCA[12]= {0xCA,0x00,0xE4,0xE4,0xE4,0xE4,0xE4,0xE4,0x08,0x08,0x00,0x00,};
static char tianma_nt35516_qHD_para_0xCA[12]= {0xCA,0x00,0xE4,0xE4,0xE4,0xE4,0xE4,0xE4,0x02,0x02,0x00,0x01,};
static char tianma_nt35516_qHD_para_0x4C[2]= {0x4C,0x10,};
static char tianma_nt35516_qHD_para_0x3A[2]= {0x3A,0x77,};
static char tianma_nt35516_qHD_para_0x36[2]= {0x36,0x00,};
static char tianma_nt35516_qHD_para_0xE0_page0[3]= {0xE0,0x00,0x03,}; //modify 6.5Khz pwm 20121127
static char tianma_nt35516_qHD_para_0xF0_page1[6]= {0xF0,0x55,0xAA,0x52,0x08,0x01,};
static char tianma_nt35516_qHD_para_0xB0[2]= {0xB0,0x0A,};
static char tianma_nt35516_qHD_para_0xB6_page1[2]= {0xB6,0x54,};
...
static char tianma_nt35516_qHD_para_0xBE[2]= {0xBE,0x3D,};
static char tianma_nt35516_qHD_para_0xD0[5]= {0xD0,0x0A,0x10,0x0D,0x0F,};
static char tianma_nt35516_qHD_para_0xD1[17]= {0xD1,0x00,0x00,0x00,0x74,0x00,0xC9,0x01,0x05,0x01,0x16,0x01,0x3E,0x01,0x66,0x01,0x95,};
static char tianma_nt35516_qHD_para_0xD2[17]= {0xD2,0x01,0xB8,0x01,0xE5,0x02,0x1B,0x02,0x5D,0x02,0x93,0x02,0x95,0x02,0xC4,0x02,0xF8,};
static char tianma_nt35516_qHD_para_0xD3[17]= {0xD3,0x03,0x18,0x03,0x44,0x03,0x60,0x03,0x82,0x03,0x98,0x03,0xB5,0x03,0xDB,0x03,0xF0,};
static char tianma_nt35516_qHD_para_0xD4[5]= {0xD4,0x03,0xF7,0x03,0xF8,};
static char tianma_nt35516_qHD_para_0xD5[17]= {0xD5,0x00,0x00,0x00,0x74,0x00,0xC9,0x01,0x05,0x01,0x16,0x01,0x3E,0x01,0x66,0x01,0x95,};
static char tianma_nt35516_qHD_para_0xD6[17]= {0xD6,0x01,0xB8,0x01,0xE5,0x02,0x1B,0x02,0x5D,0x02,0x93,0x02,0x95,0x02,0xC4,0x02,0xF8,};
static char tianma_nt35516_qHD_para_0xD7[17]= {0xD7,0x03,0x18,0x03,0x44,0x03,0x60,0x03,0x82,0x03,0x98,0x03,0xB5,0x03,0xDB,0x03,0xF0,};
static char tianma_nt35516_qHD_para_0xD8[5]= {0xD8,0x03,0xF7,0x03,0xF8,};
static char tianma_nt35516_qHD_para_0xD9[17]= {0xD9,0x00,0x00,0x00,0x74,0x00,0xC9,0x01,0x05,0x01,0x16,0x01,0x3E,0x01,0x66,0x01,0x95,};
static char tianma_nt35516_qHD_para_0xDD[17]= {0xDD,0x01,0xB8,0x01,0xE5,0x02,0x1B,0x02,0x5D,0x02,0x93,0x02,0x95,0x02,0xC4,0x02,0xF8,};
static char tianma_nt35516_qHD_para_0xDE[17]= {0xDE,0x03,0x18,0x03,0x44,0x03,0x60,0x03,0x82,0x03,0x98,0x03,0xB5,0x03,0xDB,0x03,0xF0,};
static char tianma_nt35516_qHD_para_0xDF[5]= {0xDF,0x03,0xF7,0x03,0xF8,};
static char tianma_nt35516_qHD_para_0xE0[17]= {0xE0,0x00,0x00,0x00,0x74,0x00,0xC9,0x01,0x05,0x01,0x16,0x01,0x3E,0x01,0x66,0x01,0x95,};
static char tianma_nt35516_qHD_para_0xE1[17]= {0xE1,0x01,0xB8,0x01,0xE5,0x02,0x1B,0x02,0x5D,0x02,0x93,0x02,0x95,0x02,0xC4,0x02,0xF8,};
static char tianma_nt35516_qHD_para_0xE2[17]= {0xE2,0x03,0x18,0x03,0x44,0x03,0x60,0x03,0x82,0x03,0x98,0x03,0xB5,0x03,0xDB,0x03,0xF0,};
static char tianma_nt35516_qHD_para_0xE3[5]= {0xE3,0x03,0xF7,0x03,0xF8,};
static char tianma_nt35516_qHD_para_0xE4[17]= {0xE4,0x00,0x00,0x00,0x74,0x00,0xC9,0x01,0x05,0x01,0x16,0x01,0x3E,0x01,0x66,0x01,0x95,};
static char tianma_nt35516_qHD_para_0xE5[17]= {0xE5,0x01,0xB8,0x01,0xE5,0x02,0x1B,0x02,0x5D,0x02,0x93,0x02,0x95,0x02,0xC4,0x02,0xF8,};
static char tianma_nt35516_qHD_para_0xE6[17]= {0xE6,0x03,0x18,0x03,0x44,0x03,0x60,0x03,0x82,0x03,0x98,0x03,0xB5,0x03,0xDB,0x03,0xF0,};
static char tianma_nt35516_qHD_para_0xE7[5]= {0xE7,0x03,0xF7,0x03,0xF8,};
static char tianma_nt35516_qHD_para_0xE8[17]= {0xE8,0x00,0x00,0x00,0x74,0x00,0xC9,0x01,0x05,0x01,0x16,0x01,0x3E,0x01,0x66,0x01,0x95,};
static char tianma_nt35516_qHD_para_0xE9[17]= {0xE9,0x01,0xB8,0x01,0xE5,0x02,0x1B,0x02,0x5D,0x02,0x93,0x02,0x95,0x02,0xC4,0x02,0xF8,};
static char tianma_nt35516_qHD_para_0xEA[17]= {0xEA,0x03,0x18,0x03,0x44,0x03,0x60,0x03,0x82,0x03,0x98,0x03,0xB5,0x03,0xDB,0x03,0xF0,};
static char tianma_nt35516_qHD_para_0xEB[5]= {0xEB,0x03,0xF7,0x03,0xF8,};
/*-------------liyeqing change 20121116 end -----------------*/

//liyeqing add for a temporary version of F03 begin, 20121116
#ifndef CONFIG_BACKLIGHT_CABC
static char tianma_nt35516_qHD_para_0x51_off[2]= {0x51,0xff,};
static char tianma_nt35516_qHD_para_0x53_off[2]= {0x53,0x2c,};
...
static struct dsi_cmd_desc nt35516_tianma_display_on_cmds[] = {
	...
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0x36),tianma_nt35516_qHD_para_0x36},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xE0_page0),tianma_nt35516_qHD_para_0xE0_page0},//pwm 6.5khz 20121127
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xF0_page1),tianma_nt35516_qHD_para_0xF0_page1},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xB0),tianma_nt35516_qHD_para_0xB0},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xB6_page1),tianma_nt35516_qHD_para_0xB6_page1},
	...
	//liyeqing add for a temporary version of F03 begin, 20121116
	#ifndef CONFIG_BACKLIGHT_CABC	
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0x51_off),tianma_nt35516_qHD_para_0x51_off},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0x53_off),tianma_nt35516_qHD_para_0x53_off},
...
#endif
//wangminrong add tianma xin 2012.12.04  for liyeqing
static char tianma_nt35516_qHD_para_0xF0[6]= {0xF0,0x55,0xAA,0x52,0x08,0x00,};
static char tianma_nt35516_qHD_para_0xE0[3]= {0xE0,0x00,0x03,};//pwm_clock=6.5KHz 20121127
static char tianma_nt35516_qHD_para_0xB1[4]= {0xB1,0xFC,0x00,0x00,};
static char tianma_nt35516_qHD_para_0xB6[2]= {0xB6,0x0B,};
static char tianma_nt35516_qHD_para_0xB7[3]= {0xB7,0x72,0x72,};
static char tianma_nt35516_qHD_para_0xB8[5]= {0xB8,0x01,0x04,0x04,0x04,};
static char tianma_nt35516_qHD_para_0xBA[2]= {0xBA,0x05,};
static char tianma_nt35516_qHD_para_0xBC[4]= {0xBC,0x00,0x00,0x00,};
static char tianma_nt35516_qHD_para_0xBB[4]= {0xBB,0x53,0x03,0x53,};
static char tianma_nt35516_qHD_para_0xC7[2]= {0xC7,0x70,};
static char tianma_nt35516_qHD_para_0xC9[7]= {0xC9,0x41,0x06,0x0D,0x3A,0x17,0x00,};//20121127
static char tianma_nt35516_qHD_para_0xCA[12]= {0xCA,0x00,0xE4,0xE4,0xE4,0xE4,0xE4,0xE4,0x08,0x08,0x00,0x01,};
static char tianma_nt35516_qHD_para_0x4C[2]= {0x4C,0x10,};
static char tianma_nt35516_qHD_para_0x3A[2]= {0x3A,0x77,};
static char tianma_nt35516_qHD_para_0x36[2]= {0x36,0x00,};
static char tianma_nt35516_qHD_para_0xF0_page1[6]= {0xF0,0x55,0xAA,0x52,0x08,0x01,};
...
static char tianma_nt35516_qHD_para_0xB8_page1[2]= {0xB8,0x30,};
static char tianma_nt35516_qHD_para_0xB3[2]= {0xB3,0x0D,};
static char tianma_nt35516_qHD_para_0xB9[2]= {0xB9,0x34,};
static char tianma_nt35516_qHD_para_0xB4[2]= {0xB4,0x08,};
static char tianma_nt35516_qHD_para_0xBA_page1[2]= {0xBA,0x24,};
static char tianma_nt35516_qHD_para_0xBC_page1[4]= {0xBC,0x00,0x78,0x00,};
static char tianma_nt35516_qHD_para_0xBD[4]= {0xBD,0x00,0x78,0x00,};
static char tianma_nt35516_qHD_para_0xBE[2]= {0xBE,0x3E,};
static char tianma_nt35516_qHD_para_0xD0[5]= {0xD0,0x0A,0x10,0x0D,0x0F,};
static char tianma_nt35516_qHD_para_0xD1[17]= {0xD1,0x00,0x00,0x00,0x74,0x00,0xC9,0x01,0x05,0x01,0x16,0x01,0x3E,0x01,0x66,0x01,0x95,};
static char tianma_nt35516_qHD_para_0xD2[17]= {0xD2,0x01,0xB8,0x01,0xE5,0x02,0x1B,0x02,0x5D,0x02,0x93,0x02,0x95,0x02,0xC4,0x02,0xF8,};
static char tianma_nt35516_qHD_para_0xD3[17]= {0xD3,0x03,0x18,0x03,0x44,0x03,0x60,0x03,0x82,0x03,0x98,0x03,0xB5,0x03,0xDB,0x03,0xF0,};
...
static char tianma_nt35516_qHD_para_0xDE[17]= {0xDE,0x03,0x18,0x03,0x44,0x03,0x60,0x03,0x82,0x03,0x98,0x03,0xB5,0x03,0xDB,0x03,0xF0,};
static char tianma_nt35516_qHD_para_0xDF[5]= {0xDF,0x03,0xF7,0x03,0xF8,};
static char tianma_nt35516_qHD_para_0xE0_page1[17]= {0xE0,0x00,0x00,0x00,0x74,0x00,0xC9,0x01,0x05,0x01,0x16,0x01,0x3E,0x01,0x66,0x01,0x95,};
static char tianma_nt35516_qHD_para_0xE1[17]= {0xE1,0x01,0xB8,0x01,0xE5,0x02,0x1B,0x02,0x5D,0x02,0x93,0x02,0x95,0x02,0xC4,0x02,0xF8,};
static char tianma_nt35516_qHD_para_0xE2[17]= {0xE2,0x03,0x18,0x03,0x44,0x03,0x60,0x03,0x82,0x03,0x98,0x03,0xB5,0x03,0xDB,0x03,0xF0,};
static char tianma_nt35516_qHD_para_0xE3[5]= {0xE3,0x03,0xF7,0x03,0xF8,};
static char tianma_nt35516_qHD_para_0xE4[17]= {0xE4,0x00,0x00,0x00,0x74,0x00,0xC9,0x01,0x05,0x01,0x16,0x01,0x3E,0x01,0x66,0x01,0x95,};
...
static struct dsi_cmd_desc nt35516_tianma_display_on_cmds[] = {
	...
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xF0),tianma_nt35516_qHD_para_0xF0},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xE0),tianma_nt35516_qHD_para_0xE0},// set pwm_clock 20121127
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xB1),tianma_nt35516_qHD_para_0xB1},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xB6),tianma_nt35516_qHD_para_0xB6},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xB7),tianma_nt35516_qHD_para_0xB7},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xB8),tianma_nt35516_qHD_para_0xB8},
	...
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xBB),tianma_nt35516_qHD_para_0xBB},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xC7),tianma_nt35516_qHD_para_0xC7},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xC9),tianma_nt35516_qHD_para_0xC9},//20121127
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xCA),tianma_nt35516_qHD_para_0xCA},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0x4C),tianma_nt35516_qHD_para_0x4C},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0x3A),tianma_nt35516_qHD_para_0x3A},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0x36),tianma_nt35516_qHD_para_0x36},
	...
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xDE),tianma_nt35516_qHD_para_0xDE},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xDF),tianma_nt35516_qHD_para_0xDF},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xE0_page1),tianma_nt35516_qHD_para_0xE0_page1},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xE1),tianma_nt35516_qHD_para_0xE1},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xE2),tianma_nt35516_qHD_para_0xE2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xE3),tianma_nt35516_qHD_para_0xE3},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(tianma_nt35516_qHD_para_0xE4),tianma_nt35516_qHD_para_0xE4},
   ...
   static char para5[2] = {0x00,0x00};
      ...
      static char para22[2] = {0xC1,0x66}; //11.16  //0x55
...
void mipi_set_backlight_f03(struct msm_fb_data_type *mfd)
{
	...
	// mipi_zte_set_backlight(mfd);
	 ...
	 if (lcd_id_type == 11  || lcd_id_type == 12) //zhoufan
	 {
	...
	//[ECID:0000]ZTE_BSP liyeqing add for CABC of tianma hx8369a02 , end --20121012
	 //[ECID:0000]ZTE_BSP maxiaoping 20120913 for yushun r61408 lcd cabc driver,end.
	 else
...
#else
void mipi_set_backlight_no_cabc(struct msm_fb_data_type *mfd)
{
	 ...
	 //[ECID:0000]ZTE_BSP maxiaoping 20120803 disable print logs,start.
	 printk("enter no cabc keep pwm high \r\n");
	 //[ECID:0000]ZTE_BSP maxiaoping 20120803 disable print logs,end.
	...
	// mipi_zte_set_backlight(mfd);
	 ...
	 if (lcd_id_type == 11 )
	 {
	  printk("liyeqing ----- add for CABC it is a JDF + OTM9608A IC \n");
	  
		//[ECID:0000]ZTE_BSP liyeqing add for derease the level of LCD's brightness 20121015, end		
		  
		mipi_set_tx_power_mode(0);
		  mipi_dsi_cmds_tx(&qhd_tx_buf, otm9608a_display_on_no_CABC_backlight_cmds,ARRAY_SIZE(otm9608a_display_on_no_CABC_backlight_cmds));
 			mipi_set_tx_power_mode(1);
	   }
	...
	//[ECID:0000]ZTE_BSP liyeqing add for CABC of tianma hx8369a02 , begin --20121012	
	else if (lcd_id_type == 10 )
	 {
	    ...
	    mipi_set_tx_power_mode(0);
		  mipi_dsi_cmds_tx(&qhd_tx_buf, tianma_nt35516_display_on_no_CABC_backlight_cmds,ARRAY_SIZE(tianma_nt35516_display_on_no_CABC_backlight_cmds));
 			mipi_set_tx_power_mode(1);
	   }
...
{	
	...
	pinfo->clk_rate = 493000000;//455000000;//liyeqing change 20121022 420-->447
//	pinfo->lcdc.h_back_porch = 150;//75;//100
//	pinfo->lcdc.h_front_porch = 150;//75;//100
//	pinfo->lcdc.h_pulse_width = 10;//10;
//	pinfo->lcdc.v_back_porch = 26;//26;//lead panel must use 26
//	pinfo->lcdc.v_front_porch = 10;//10;
//	pinfo->lcdc.v_pulse_width = 10;// 10;
/*	pinfo->lcdc.h_back_porch = 80;//75;//100
	pinfo->lcdc.h_front_porch = 24;//75;//100
	pinfo->lcdc.h_pulse_width = 8;//10;
	pinfo->lcdc.v_back_porch = 16;//26;//lead panel must use 26
	pinfo->lcdc.v_front_porch = 8;//10;
	pinfo->lcdc.v_pulse_width =1;// 10;
*/

//	pinfo->clk_rate = 455000000;//liyeqing change 20121022 420-->447
