...
//ZTEBSP zhoufan add for lcd start 20130221   
#if defined (CONFIG_PROJECT_P865E02)||defined(CONFIG_PROJECT_P865V20)   
//ZTEBSP zhoufan add for lcd end 20130221   
...
//[ECID:0000]ZTE_BSP maxiaoping 20120913 for yushun r61408 lcd cabc driver,start.
...
#endif
//ZTEBSP zhoufan add for hx8363 yushun lcd  start 20130221
#if 0
...
#endif
#if 1
static char hx8363_yushun_para0[2] = {0x11,0x00};
static char hx8363_yushun_para1[4] = {0xB9,0xFF,0x83,0x63};  
static char hx8363_yushun_para2[13] = {0xB1,0x78,0x34,0x07,0x33,0x02,0x13,0x11,0x00,0x35,0x3E,0x3F,0x3F};
static char hx8363_yushun_para3[4] = {0xB2,0x33,0x33,0x22};
static char hx8363_yushun_para4[2] = {0x3A,0x70};
static char hx8363_yushun_para5[2] = {0x36,0x02};    //fangxiang
static char hx8363_yushun_para6[2] = {0xB3,0x01};
static char hx8363_yushun_para7[10] = {0xB4,0x08,0x12,0x72,0x12,0x06,0x03,0x54,0x03,0x4E};
static char hx8363_yushun_para8[2] = {0xB6,0x26};
static char hx8363_yushun_para9[2] = {0xCC,0x01};
static char hx8363_yushun_para10[14] = {0xBA,0x80,0x00,0x10,0x08,0x08,0x70,0x7C,0x6E,0x6D,0x0A,0x01,0x84,0x43};
static char hx8363_yushun_para11[31] = {0xE0,0x00,0x1F,0x61,0x13,0x13,0x3F,0x0D,0xD1,0x50,0x15,0x17,0xD5,0x96,0x93,0x19,0x00,0x1F,0x61,0x13,0x13,0x3F,0x0D,0xD0,0x50,0x15,0x17,0xD5,0x96,0x93,0x19};
static char hx8363_yushun_para12[2] = {0x29,0x00};
static struct dsi_cmd_desc hx8363_yushun_display_on_cmds[] = 
{
	{DTYPE_DCS_WRITE, 1, 0, 0, 120,sizeof(hx8363_yushun_para0),hx8363_yushun_para0},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(hx8363_yushun_para1),hx8363_yushun_para1},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(hx8363_yushun_para2),hx8363_yushun_para2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(hx8363_yushun_para3),hx8363_yushun_para3},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,sizeof(hx8363_yushun_para4),hx8363_yushun_para4},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,sizeof(hx8363_yushun_para5),hx8363_yushun_para5},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,sizeof(hx8363_yushun_para6),hx8363_yushun_para6},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(hx8363_yushun_para7),hx8363_yushun_para7},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,sizeof(hx8363_yushun_para8),hx8363_yushun_para8},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0,sizeof(hx8363_yushun_para9),hx8363_yushun_para9},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(hx8363_yushun_para10),hx8363_yushun_para10},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0,sizeof(hx8363_yushun_para11),hx8363_yushun_para11},
	{DTYPE_DCS_WRITE, 1, 0, 0, 10,sizeof(hx8363_yushun_para12),hx8363_yushun_para12},
};
#endif
//ZTEBSP zhoufan add for hx8363 yushun lcd end 20130221
...
static u32 __init get_lcdpanleid_from_bootloader(void)
{
		...
		{	
			...
			case 9:
				return (u32)LCD_PANEL_4P0_HX8363_IVO_YUSHUN;
			case 8:
			    return (u32)LCD_PANEL_4P0_R61408_TRULY_LG;//[ECID:0000] ZTEBSP wangminrong for yushun R61408 for P825B20
			case 20:
			    return (u32)LCD_PANEL_4P0_R61408_YUSHUN_LG;//[ECID:0000] ZTEBSP wangminrong for yushun R61408 for P825B20
			default:
				break;
		}
...
static int mipi_lcd_off(struct platform_device *pdev)
{
	...
	gpio_direction_output(GPIO_LCD_RESET,0);
	//[ECID:0000] ZTEBSP wangminrong start 20120629 for mipi into ulps the reset gpio will be high
	msleep(5);
	gpio_direction_output(GPIO_LCD_RESET,1);
	msleep(10);
//	gpio_direction_output(121,0);
	
	//[ECID:0000] ZTEBSP wangminrong end 20120629 for mipi into ulps the reset gpio will be high
	return 0;
}
...
//[ECID:0000] ZTEBSP wangminrong start  20120618 for logo first is return
	...
	switch(LcdPanleID){
		...
		case (u32)LCD_PANEL_4P0_HX8363_IVO_YUSHUN:
				...
				break;
		case (u32)LCD_PANEL_4P0_R61408_YUSHUN_LG: //[ECID:0000] ZTEBSP wangminrong for yushun R61408 for P825B20 20120824
		...
		//	msleep(500);
	 	...
	 	else
	   	{
			...
			//r61408_truly_para_CABC_0xb9_on[1]=0x01;            //zhoufan--
	      		r61408_truly_para_CABC_0xb9_on[2]=((11*current_lel)/2-1);
			mipi_set_tx_power_mode(0);
...
//[ECID:0000] ZTEBSP wangminrong for yushun R61408 for P825B20 start 20120824
...
//[ECID:0000] ZTEBSP wangminrong for yushun R61408 for P825B20 end 20120824 
