...
{
    s32 ret = 0;
    GTP_GPIO_FREE(GTP_INT_PORT);   //haoweiwei add to solve gpio request failed
...
//    ts->irq_lock = SPIN_LOCK_UNLOCKED;  haoweiwei delect     
...
//    spin_lock_init(&ts->irq_lock);       haoweiwei delect
//    ts->irq_lock = SPIN_LOCK_UNLOCKED;   haoweiwei delect
