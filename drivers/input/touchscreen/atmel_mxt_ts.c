...
static void mxt_input_report(struct mxt_data *data, int single_id)
{
	...
	if (status != MXT_RELEASE) {
		input_report_abs(input_dev, ABS_X, finger[single_id].y);
		input_report_abs(input_dev, ABS_Y, data->max_x-finger[single_id].x);
...
static const char ts_keys_size[] = "0x01:158:210:2030:110:100:0x01:172:540:2030:120:100:0x01:139:770:2030:110:100";
