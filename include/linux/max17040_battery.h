...
/* ZTEBSP yuanjinxing 20121130, max17040 driver, add ini_data struct, start */
/*
...
/* ZTEBSP yuanjinxing 20121130, max17040 driver, add ini_data struct, end */

struct max17040_platform_data {
	int (*battery_online)(void);
	int (*charger_online)(void);
	int (*charger_enable)(void);
	struct max17040_ini_data ini_data;  /* ZTEBSP yuanjinxing 20121130, max17040 driver, add menber ini_data */
};
