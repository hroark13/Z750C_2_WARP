...
#if defined (CONFIG_PROJECT_P865F01)  ||defined ( CONFIG_PROJECT_P825F01)|| defined ( CONFIG_PROJECT_P865V30) ||defined(CONFIG_PROJECT_P865V20)
...
//#define GPIO_CAMERA_1V8_EN  120 /* SKU3 1.8V LDO */
...
#ifdef CONFIG_OV7692
#if defined ( CONFIG_PROJECT_P865F01)  ||defined ( CONFIG_PROJECT_P825F01)||defined ( CONFIG_PROJECT_P865V30) ||defined(CONFIG_PROJECT_P865V20)  //yuxin modify for P825F01 front cam ov7692 2012.09.21
...
static struct msm_gpio_set_tbl sp0a28_cam_gpio_set_tbl[] = {
	...
	{GPIO_CAMERA_2V8_AVDD_EN,GPIOF_OUT_INIT_HIGH,3000},
	{GPIO_FRONT_CAM_PWDN, GPIOF_OUT_INIT_HIGH, 3000},  
	{GPIO_FRONT_CAM_PWDN, GPIOF_OUT_INIT_LOW, 10000}, 
...
/*ZTEBSP yuxin modify for init GPIOs,2012.09.20 ++*/
   ...
   like extenal LDO En pins, Mclk switch pin. The camera's own EN pins are init in the sensor driver code*/
	...
	/*gpio_tlmm_config(GPIO_CFG(GPIO_CAMERA_1V8_EN, 0,
		GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN,
		GPIO_CFG_2MA), GPIO_CFG_ENABLE); */
	//gpio_direction_output(GPIO_CAMERA_2V8_MOTO_EN, 0);
