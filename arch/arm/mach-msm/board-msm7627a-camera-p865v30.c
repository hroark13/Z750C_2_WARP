...
//ZTEBSP yuxin modify for use PRJ feature to control the GPIO pin 2013.01.07 ++
#if defined (CONFIG_PROJECT_P865V30) 
#define GPIO_FRONT_CAM_PWDN                   18   //front cam PWDN pin 
//#define GPIO_FRONT_CAM_RESET                   119   //front cam RESET pin   SP0A28 NOT USED
#define GPIO_BACK_CAM_5MP_PWDN             122  //back cam PWDN pin 
#define GPIO_BACK_CAM_5MP_RESET             123  //back cam RESET pin 

#define GPIO_CAMERA_2V8_AVDD_EN              35   //AVDD 2.8V LDO EN pin
#define GPIO_CAMERA_1V8_DVDD_EN              120   //DVDD 1.8V LDO EN pin
#define GPIO_CAMERA_2V8_MOTO_EN             116   //AF VCM AVDD 2.8V LDO EN pin

//ZTEBSP doumingming modify for P865V20
#elif  defined(CONFIG_PROJECT_P865V20)
//#define GPIO_FRONT_CAM_PWDN                   18   //front cam PWDN pin 
//#define GPIO_FRONT_CAM_RESET                   119   //front cam RESET pin   SP0A28 NOT USED
#define GPIO_BACK_CAM_5MP_PWDN             122  //back cam PWDN pin 
#define GPIO_BACK_CAM_5MP_RESET             123  //back cam RESET pin 
...
#ifdef CONFIG_OV7692
#if defined ( CONFIG_PROJECT_P865F01) ||defined ( CONFIG_PROJECT_P865V30) ||defined ( CONFIG_PROJECT_P825F01) //yuxin modify for P825F01 front cam ov7692 2012.09.21
static struct gpio ov7692_cam_req_gpio[] = {
    ...
    //{GPIO_CAMERA_1V8_EN,GPIOF_DIR_OUT,"OV7692_DVDD"},	
    {GPIO_BACK_CAM_5MP_PWDN, GPIOF_DIR_OUT, "BACK_PWDN"},
    {GPIO_BACK_CAM_5MP_RESET,GPIOF_DIR_OUT,"BACK_RESET"},
};

static struct msm_gpio_set_tbl ov7692_cam_gpio_set_tbl[] = {
    {GPIO_BACK_CAM_5MP_PWDN, GPIOF_OUT_INIT_LOW, 1000}, // make back camera not work
    {GPIO_BACK_CAM_5MP_RESET,GPIOF_OUT_INIT_LOW, 1000},
	{GPIO_FRONT_CAM_PWDN, GPIOF_OUT_INIT_HIGH, 5000},
	//{GPIO_CAMERA_1V8_EN,GPIOF_OUT_INIT_HIGH,5000},
	{GPIO_CAMERA_2V8_AVDD_EN,GPIOF_OUT_INIT_HIGH,5000},
...
static struct msm_gpio_set_tbl back_cam_gpio_set_tbl_zte_1[] = {
	...
	{GPIO_CAMERA_2V8_AVDD_EN,GPIOF_OUT_INIT_HIGH,1000},
	//{GPIO_CAMERA_1V8_EN,GPIOF_OUT_INIT_HIGH,1000},
	{GPIO_CAMERA_2V8_MOTO_EN,GPIOF_OUT_INIT_HIGH,1000},
...
static struct msm_gpio_set_tbl hi542_cam_gpio_set_tbl[] = {
	...
	{GPIO_CAMERA_1V8_DVDD_EN,GPIOF_OUT_INIT_HIGH,2000},
	{GPIO_CAMERA_2V8_AVDD_EN,GPIOF_OUT_INIT_HIGH,1000},
	{GPIO_CAMERA_2V8_MOTO_EN,GPIOF_OUT_INIT_HIGH,1000},
	{GPIO_BACK_CAM_5MP_RESET, GPIOF_OUT_INIT_HIGH, 5000},
	{GPIO_BACK_CAM_5MP_PWDN, GPIOF_OUT_INIT_HIGH, 5000},
...
/*ZTEBSP yuxin add for P865F03 use sp0a28 2012.11.07 ++*/
#ifdef CONFIG_SP0A28
...
static struct msm_gpio_set_tbl sp0a28_cam_gpio_set_tbl[] = {
	...
	{GPIO_CAMERA_2V8_AVDD_EN,GPIOF_OUT_INIT_HIGH,1000},
	{GPIO_CAMERA_1V8_DVDD_EN,GPIOF_OUT_INIT_HIGH,1000},
	{GPIO_FRONT_CAM_PWDN, GPIOF_OUT_INIT_HIGH, 2000},  
	{GPIO_FRONT_CAM_PWDN, GPIOF_OUT_INIT_LOW, 1000}, 
...
#if defined ( CONFIG_PROJECT_P865V30) ||defined ( CONFIG_PROJECT_P865V20)
...
static struct msm_camera_sensor_platform_info sensor_board_info_ov7692 = {
	.mount_angle = 270,//zhangzhao for 825f01 2012-8-28
...
static struct msm_camera_sensor_info msm_camera_sensor_ov7692_data = {
	...
	//.sensor_reset	   = GPIO_SKU1_CAM_VGA_RESET_N,//zhangzhao no rst
...
#define VFE_CAMIF_TIMER1_GPIO 14
#define VFE_CAMIF_TIMER2_GPIO 117

static struct msm_camera_sensor_flash_src msm_flash_src = {
	.flash_sr_type = MSM_CAMERA_FLASH_SRC_EXT,
	._fsrc.ext_driver_src.led_en = VFE_CAMIF_TIMER1_GPIO,  /* connects to TX pin */
	._fsrc.ext_driver_src.led_flash_en = VFE_CAMIF_TIMER2_GPIO, /* connects to STROBE pin */
...
/*ZTEBSP yuxin modify for init GPIOs,2012.09.20 ++*/
   ...
   like extenal LDO En pins, Mclk switch pin. The camera's own EN pins are init in the sensor driver code*/
	...
	gpio_tlmm_config(GPIO_CFG(
				...
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	gpio_tlmm_config(GPIO_CFG(
				GPIO_BACK_CAM_5MP_PWDN,
				0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	gpio_tlmm_config(GPIO_CFG(
				GPIO_BACK_CAM_5MP_RESET,
				0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	gpio_tlmm_config(GPIO_CFG(
		             GPIO_CAMERA_2V8_MOTO_EN,
				0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	gpio_tlmm_config(GPIO_CFG(GPIO_CAMERA_2V8_AVDD_EN, 0,
		             GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL,
		             GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	gpio_tlmm_config(GPIO_CFG(GPIO_CAMERA_1V8_DVDD_EN, 0,
		             GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN,
		             GPIO_CFG_2MA), GPIO_CFG_ENABLE); 
		             
#elif defined ( CONFIG_PROJECT_P865V20)  //yuxin add for P865V20 2013.02.04 
  gpio_tlmm_config(GPIO_CFG(
				GPIO_BACK_CAM_5MP_PWDN,
				0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);
...
void __init msm7627a_camera_init(void)
{
	...
	int rc;
#endif
	pr_err("msm7627a_camera_init Entered\n");
