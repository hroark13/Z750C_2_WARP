...
#if defined ( CONFIG_PROJECT_P825A10 ) || defined ( CONFIG_PROJECT_P825F01 ) || defined ( CONFIG_PROJECT_P865F01 ) || defined ( CONFIG_PROJECT_P865F03 )|| defined ( CONFIG_PROJECT_P865V30 ) ||defined ( CONFIG_PROJECT_P865V20)
...
/*[ECID:000000] ZTEBSP wangbing, for P825A10 LCD, 20120420 */	
	...
	PCOM_VREG_LDO(ldo01, 12, NULL, 1800000, 3000000, 0, -1, 0, 0, 0, 0, p),
#else
	...
	/*[ECID:000000] ZTEBSP zhangbo change voltage range, start*/
	PCOM_VREG_LDO(ldo19, 57, NULL, 1200000, 3050000, 0, -1, 0, 0, 0, 0, p),
	/*[ECID:000000] ZTEBSP zhangbo change voltage range, end*/
