...
/*[ECID:000000] ZTEBSP wangbing, for P825A10 download, 20120424 start*/
...
/*[ECID:000000] ZTEBSP wangbing, for P825A10 download, 20120424 end*/
...
/*[ECID:000000] ZTEBSP wangbing, for P825A10 download, 20120424 */
...
/* [ECID:000000] ZTEBSP wangjianping start 20120423 modify sd card detect gpio */
static int gpio_sdc1_hw_det = ZTE_GPIO_SDCARD_DET; 
/* [ECID:000000] ZTEBSP wangjianping end 20120423 modify sd card detect gpio */
...
/*[ECID:000000] ZTEBSP wangbing, for P825A10 micro-SD, 20120424 */
#if defined ( CONFIG_PROJECT_P825A10 ) || defined ( CONFIG_PROJECT_P825F01 ) || defined ( CONFIG_PROJECT_P865F01 )|| defined ( CONFIG_PROJECT_P865E02 )\
	||defined(CONFIG_PROJECT_V72A)  || defined ( CONFIG_PROJECT_P865F03 ) || defined ( CONFIG_PROJECT_P865V30 ) ||defined ( CONFIG_PROJECT_P865V20)
	status = gpio_tlmm_config(GPIO_CFG(gpio_sdc1_hw_det, 0, GPIO_CFG_INPUT,
				GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
				GPIO_CFG_ENABLE);
#else
	/*[ECID:000000]ZTEBSP zhangbo change for ad card, start*/
	status = gpio_tlmm_config(GPIO_CFG(gpio_sdc1_hw_det, 0, GPIO_CFG_INPUT,
				GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
				GPIO_CFG_ENABLE);
	/*[ECID:000000]ZTEBSP zhangbo change for ad card, end*/
#endif
	if (status)
	...
	if (status) {
		...
		if (!status) {
			/*[ECID:000000] ZTEBSP zhangbo, change for sd card, start*/
			/*
			if (machine_is_msm7627a_qrd1() ||
				...
				status = gpio_get_value(gpio_sdc1_hw_det);
			*/
				//low level after inserting sd card
				status = !gpio_get_value(gpio_sdc1_hw_det);
			/*[ECID:000000] ZTEBSP zhangbo, change for sd card, end*/
		}
...
static struct mmc_platform_data sdc1_plat_data = {
	...
	.status_irq = MSM_GPIO_TO_INT(ZTE_GPIO_SDCARD_DET),  //[ECID:000000] ZTEBSP zhangbo add for Tcard detection
