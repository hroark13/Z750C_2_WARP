...
#if  0 //ECID:0000 zhangzhao 2012-4-23 modified for camera
#define GPIO_SKU1_CAM_VGA_SHDN    39 //zhangzhao 18
#define GPIO_SKU1_CAM_VGA_RESET_N 98  //zhangzhao
#define GPIO_SKU3_CAM_5MP_SHDN_N   30 //zhangzhao 5         /* PWDN */
#define GPIO_SKU3_CAM_5MP_CAMIF_RESET   17 //zhangzhao 6    /* (board_is(EVT))?123:121 RESET */
#define GPIO_SKU3_CAM_5MP_CAM_DRIVER_PWDN //30
#define GPIO_CAM_MCLK_SWITCH   49
#endif
//ZTEBSP yuxin modify for use PRJ feature to control the GPIO pin 2012.09.19 ++
#ifdef CONFIG_PROJECT_V72A 
//sensors' EN GPIO pins
#define GPIO_FRONT_CAM_PWDN                   39    //front cam PWDN pin 
#define GPIO_FRONT_CAM_RESET                  98  //front cam RESET pin 
#define GPIO_BACK_CAM_PWDN                      30    //back cam PWDN pin 
#define GPIO_BACK_CAM_RESET                     17  //back cam RESET pin 
//cam power supply LDO En GPIO pins
#define GPIO_CAMERA_2V8_AVDD_EN                 58   //AVDD 2.8V LDO EN pin
//#define GPIO_CAMERA_1V8_DVDD_EN               84   //no thsi pin
#else  //Qualcomm org code
...
//ZTEBSP yuxin add CONFIG control sensor code, 2012.09.19 ++
#ifdef CONFIG_S5K4E1  
...
#ifdef CONFIG_OV7692
#ifdef CONFIG_PROJECT_P825F01  //yuxin modify for P825F01 front cam ov7692 2012.09.21
static struct gpio ov7692_cam_req_gpio[] = {
       {GPIO_CAMERA_2V8_AVDD_EN,GPIOF_DIR_OUT,"CAM_AVDD"},
	{GPIO_FRONT_CAM_PWDN, GPIOF_DIR_OUT, "OV7692_PWDN"},
};

static struct msm_gpio_set_tbl ov7692_cam_gpio_set_tbl[] = {
	{GPIO_FRONT_CAM_PWDN, GPIOF_OUT_INIT_HIGH, 1000},
	{GPIO_CAMERA_2V8_AVDD_EN,GPIOF_OUT_INIT_HIGH,1000},
	{GPIO_FRONT_CAM_PWDN, GPIOF_OUT_INIT_LOW, 5000},
};
#else //Qualcomm org code
static struct gpio ov7692_cam_req_gpio[] = {
...
#ifdef CONFIG_OV5640
//YUXIN ADD FOR OV5640 gpio
static struct gpio back_cam_req_gpio_zte[] = {
    {GPIO_CAMERA_2V8_AVDD_EN,GPIOF_DIR_OUT,"CAM_AVDD"},
    {GPIO_CAMERA_2V8_MOTO_EN,GPIOF_DIR_OUT,"CAM_AF_AVDD"},
    {GPIO_FRONT_CAM_PWDN, GPIOF_DIR_OUT, "OV7692_PWDN"},
    {GPIO_BACK_CAM_5MP_PWDN, GPIOF_DIR_OUT, "OV5640_PWDN"},
    {GPIO_BACK_CAM_5MP_RESET,GPIOF_DIR_OUT,"OV5640_RESET"},
};

static struct msm_gpio_set_tbl back_cam_gpio_set_tbl_zte[] = {
	{GPIO_FRONT_CAM_PWDN,GPIOF_OUT_INIT_HIGH,1000},  //MAKE OV7692 NOT WORK
	{GPIO_BACK_CAM_5MP_PWDN, GPIOF_OUT_INIT_HIGH, 1000},
	{GPIO_CAMERA_2V8_AVDD_EN,GPIOF_OUT_INIT_HIGH,1000},
	{GPIO_CAMERA_2V8_MOTO_EN,GPIOF_OUT_INIT_HIGH,1000},
	{GPIO_BACK_CAM_5MP_PWDN, GPIOF_OUT_INIT_LOW, 5000},
	{GPIO_BACK_CAM_5MP_RESET, GPIOF_OUT_INIT_HIGH, 5000},
	{GPIO_BACK_CAM_5MP_RESET, GPIOF_OUT_INIT_LOW, 5000},
	{GPIO_BACK_CAM_5MP_RESET, GPIOF_OUT_INIT_HIGH, 5000},
		
};

static struct msm_camera_gpio_conf gpio_conf_ov5640 = {
	.cam_gpio_req_tbl = back_cam_req_gpio_zte,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(back_cam_req_gpio_zte),
	.cam_gpio_set_tbl = back_cam_gpio_set_tbl_zte,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(back_cam_gpio_set_tbl_zte),
	.camera_off_table = camera_off_gpio_table,
	.camera_on_table = camera_on_gpio_table,
	.gpio_no_mux = 1,
};
...
#ifdef CONFIG_JT8EV5
static struct gpio back_cam_req_gpio_zte_1[] = {
    {GPIO_CAMERA_2V8_AVDD_EN,GPIOF_DIR_OUT,"CAM_AVDD"},
    {GPIO_CAMERA_2V8_MOTO_EN,GPIOF_DIR_OUT,"CAM_AF_AVDD"},
    {GPIO_FRONT_CAM_PWDN, GPIOF_DIR_OUT, "OV7692_PWDN"},
    {GPIO_BACK_CAM_5MP_PWDN, GPIOF_DIR_OUT, "JT8EV5_PWDN"},
    {GPIO_BACK_CAM_5MP_RESET,GPIOF_DIR_OUT,"JT8EV5_RESET"},
};

static struct msm_gpio_set_tbl back_cam_gpio_set_tbl_zte_1[] = {
	{GPIO_FRONT_CAM_PWDN,GPIOF_OUT_INIT_HIGH,1000},  //MAKE OV7692 NOT WORK
	{GPIO_BACK_CAM_5MP_PWDN, GPIOF_OUT_INIT_LOW, 1000},
	{GPIO_CAMERA_2V8_AVDD_EN,GPIOF_OUT_INIT_HIGH,1000},
	{GPIO_CAMERA_2V8_MOTO_EN,GPIOF_OUT_INIT_HIGH,1000},
	{GPIO_BACK_CAM_5MP_PWDN, GPIOF_OUT_INIT_HIGH, 5000},
	{GPIO_BACK_CAM_5MP_RESET, GPIOF_OUT_INIT_HIGH, 5000},
	{GPIO_BACK_CAM_5MP_RESET, GPIOF_OUT_INIT_LOW, 5000},
	{GPIO_BACK_CAM_5MP_RESET, GPIOF_OUT_INIT_HIGH, 5000},
...
static struct msm_camera_gpio_conf gpio_conf_jt8ev5 = {
	.cam_gpio_req_tbl = back_cam_req_gpio_zte_1,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(back_cam_req_gpio_zte_1),
	.cam_gpio_set_tbl = back_cam_gpio_set_tbl_zte_1,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(back_cam_gpio_set_tbl_zte_1),
	.camera_off_table = camera_off_gpio_table,
	.camera_on_table = camera_on_gpio_table,
	.gpio_no_mux = 1,
};
...
static struct gpio back_cam_req_gpio_zte_1[] = {
    {GPIO_CAMERA_2V8_AVDD_EN,GPIOF_DIR_OUT,"CAM_BACK_AVDD"},
   // {GPIO_CAMERA_2V8_MOTO_EN,GPIOF_DIR_OUT,"CAM_AF_AVDD"},
    {GPIO_FRONT_CAM_PWDN, GPIOF_DIR_OUT, "FRONT_PWDN"},
    {GPIO_BACK_CAM_PWDN, GPIOF_DIR_OUT, "MT9D115_PWDN"},
    {GPIO_BACK_CAM_RESET,GPIOF_DIR_OUT,"JMT9D115_RESET"},
};

static struct msm_gpio_set_tbl back_cam_gpio_set_tbl_zte_1[] = {
	{GPIO_FRONT_CAM_PWDN,GPIOF_OUT_INIT_HIGH,1000},  //MAKE OV7692 NOT WORK
	{GPIO_BACK_CAM_PWDN, GPIOF_OUT_INIT_LOW, 1000},
	{GPIO_CAMERA_2V8_AVDD_EN,GPIOF_OUT_INIT_HIGH,1000},
	//{GPIO_CAMERA_2V8_MOTO_EN,GPIOF_OUT_INIT_HIGH,1000},
	//{GPIO_BACK_CAM_PWDN, GPIOF_OUT_INIT_HIGH, 5000},
	{GPIO_BACK_CAM_RESET, GPIOF_OUT_INIT_HIGH, 5000},
	{GPIO_BACK_CAM_RESET, GPIOF_OUT_INIT_LOW, 5000},
	{GPIO_BACK_CAM_RESET, GPIOF_OUT_INIT_HIGH, 5000},
		
};


static struct msm_camera_gpio_conf gpio_conf_mt9d115 = {
	.cam_gpio_req_tbl = back_cam_req_gpio_zte_1,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(back_cam_req_gpio_zte_1),
	.cam_gpio_set_tbl = back_cam_gpio_set_tbl_zte_1,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(back_cam_gpio_set_tbl_zte_1),
...
#endif
/*ZTEBSP yuxin add for hynix RAW sensor Hi542 2012.10.08 ++*/
#ifdef CONFIG_HI542

static struct gpio hi542_cam_req_gpio_tbl[] = {
    {GPIO_CAMERA_2V8_AVDD_EN,GPIOF_DIR_OUT,"CAM_AVDD"},
    {GPIO_CAMERA_2V8_MOTO_EN,GPIOF_DIR_OUT,"CAM_AF_AVDD"},
    {GPIO_BACK_CAM_5MP_PWDN, GPIOF_DIR_OUT, "HI542_PWDN"},
    {GPIO_BACK_CAM_5MP_RESET,GPIOF_DIR_OUT,"HI542_RESET"},
};

static struct msm_gpio_set_tbl hi542_cam_gpio_set_tbl[] = {
	{GPIO_BACK_CAM_5MP_RESET, GPIOF_OUT_INIT_LOW, 1000},
	{GPIO_BACK_CAM_5MP_PWDN, GPIOF_OUT_INIT_LOW, 1000}, //hi542 active low
	{GPIO_CAMERA_2V8_AVDD_EN,GPIOF_OUT_INIT_HIGH,1000},
	{GPIO_CAMERA_2V8_MOTO_EN,GPIOF_OUT_INIT_HIGH,1000},
	{GPIO_BACK_CAM_5MP_RESET, GPIOF_OUT_INIT_HIGH, 5000},
	{GPIO_BACK_CAM_5MP_PWDN, GPIOF_OUT_INIT_HIGH, 5000},
...
static struct msm_camera_gpio_conf gpio_conf_hi542 = {
	.cam_gpio_req_tbl = hi542_cam_req_gpio_tbl,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(hi542_cam_req_gpio_tbl),
...
#endif
/*ZTEBSP yuxin add for hynix RAW sensor Hi-542 2012.05.31 --*/

/*ZTEBSP yuxin add for P865e02 PRJ sensors,ov2675 and sp0a28,2012.10.19++*/
#ifdef CONFIG_OV2675
static struct gpio ov2675_cam_req_gpio_tbl[] = {
    {GPIO_CAMERA_2V8_AVDD_EN,GPIOF_DIR_OUT,"CAM_AVDD"},
    {GPIO_CAMERA_1V8_DVDD_EN,GPIOF_DIR_OUT,"CAM_DVDD"},
    {GPIO_BACK_CAM_PWDN, GPIOF_DIR_OUT, "OV2675_PWDN"},
    {GPIO_BACK_CAM_RESET,GPIOF_DIR_OUT,"OV2675_RESET"},
};

static struct msm_gpio_set_tbl ov2675_cam_gpio_set_tbl[] = {
	//{GPIO_BACK_CAM_RESET, GPIOF_OUT_INIT_LOW, 1000},
	{GPIO_BACK_CAM_PWDN, GPIOF_OUT_INIT_HIGH, 1000}, //ov2675 pwdn active high
	{GPIO_CAMERA_2V8_AVDD_EN,GPIOF_OUT_INIT_HIGH,1000},
	{GPIO_CAMERA_1V8_DVDD_EN,GPIOF_OUT_INIT_HIGH,3000},
	{GPIO_BACK_CAM_PWDN, GPIOF_OUT_INIT_LOW, 2000},  
	{GPIO_BACK_CAM_RESET, GPIOF_OUT_INIT_HIGH, 2000},//reset active low
	{GPIO_BACK_CAM_RESET, GPIOF_OUT_INIT_LOW, 2000},
	{GPIO_BACK_CAM_RESET, GPIOF_OUT_INIT_HIGH, 2000},

		
};
static struct msm_camera_gpio_conf gpio_conf_ov2675 = {
	.cam_gpio_req_tbl = ov2675_cam_req_gpio_tbl,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(ov2675_cam_req_gpio_tbl),
	.cam_gpio_set_tbl = ov2675_cam_gpio_set_tbl,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(ov2675_cam_gpio_set_tbl),
	.camera_off_table = camera_off_gpio_table,
	.camera_on_table = camera_on_gpio_table,
	.gpio_no_mux = 1,
};
...
#ifdef CONFIG_SP0A28
static struct gpio sp0a28_cam_req_gpio_tbl[] = {
    {GPIO_CAMERA_2V8_AVDD_EN,GPIOF_DIR_OUT,"CAM_AVDD"},
//    {GPIO_CAMERA_1V8_DVDD_EN,GPIOF_DIR_OUT,"CAM_DVDD"},
    {GPIO_FRONT_CAM_PWDN, GPIOF_DIR_OUT, "SP0A28_PWDN"},
    //{GPIO_FRONT_CAM_RESET,GPIOF_DIR_OUT,"SP0A28_RESET"},  //NOT USED
};

static struct msm_gpio_set_tbl sp0a28_cam_gpio_set_tbl[] = {
	{GPIO_FRONT_CAM_PWDN, GPIOF_OUT_INIT_LOW, 1000}, 
	{GPIO_CAMERA_2V8_AVDD_EN,GPIOF_OUT_INIT_HIGH,1000},
//	{GPIO_CAMERA_1V8_DVDD_EN,GPIOF_OUT_INIT_HIGH,3000},
	{GPIO_FRONT_CAM_PWDN, GPIOF_OUT_INIT_HIGH, 5000},  
	{GPIO_FRONT_CAM_PWDN, GPIOF_OUT_INIT_LOW, 1000}, 
		
};
static struct msm_camera_gpio_conf gpio_conf_sp0a28 = {
	.cam_gpio_req_tbl = sp0a28_cam_req_gpio_tbl,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(sp0a28_cam_req_gpio_tbl),
	.cam_gpio_set_tbl = sp0a28_cam_gpio_set_tbl,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(sp0a28_cam_gpio_set_tbl),
	.camera_off_table = camera_off_gpio_table,
	.camera_on_table = camera_on_gpio_table,
	.gpio_no_mux = 1,
};
...
#if 0// CONFIG_MSM_CAMERA_FLASH  //yuxin del for compile
...
#ifdef CONFIG_PROJECT_V72A//yuxin
/*MSME power is used for many devices , don't do any operation on it when cam power on and off
 so the msm_cam_vreg is not used in this file*/
//static struct camera_vreg_t msm_cam_vreg[] = {
	//{"msme1", REG_LDO, 1800000, 1800000, 0}, //DVDD 1.8V use VREG_S3
	//AVDD,AF_AVDD use externel LDO
//};
#else  //Qualcomm org code
static struct camera_vreg_t msm_cam_vreg[] = {
...
static struct msm_camera_sensor_platform_info sensor_board_info_ov7692 = {
	.mount_angle = 90,
	//.cam_vreg = msm_cam_vreg,//ECID:0000 zhangzhao 2012-4-23 modified for camera
	//.num_vreg = ARRAY_SIZE(msm_cam_vreg),
...
static struct msm_camera_sensor_info msm_camera_sensor_ov7692_data = {
	...
	.sensor_pwd	     = GPIO_FRONT_CAM_PWDN,
...
//ECID:0000 zhangzhao 2012-4-23 modified for camera start
#ifdef CONFIG_OV5640
...
#define ADP1655_LED_FLASH_TORCH    14
    ...
    static struct msm_camera_sensor_flash_src msm_zte_flash_src = {
	.flash_sr_type = MSM_CAMERA_FLASH_SRC_EXT,
	._fsrc.ext_driver_src.led_en = ADP1655_LED_FLASH_STROBE,
	._fsrc.ext_driver_src.led_flash_en = ADP1655_LED_FLASH_TORCH,
	._fsrc.ext_driver_src.flash_id = MAM_CAMERA_EXT_LED_FLASH_ADP1655,
    };
    static struct msm_camera_sensor_flash_data flash_ov5640 = {
    	.flash_type             = MSM_CAMERA_FLASH_LED,
    	.flash_src              = &msm_zte_flash_src,
    };
#else
   static struct msm_camera_sensor_flash_data flash_ov5640 = {
...
static struct msm_camera_sensor_info msm_camera_sensor_ov5640_data = {
	...
	.sensor_reset_enable = 1,
	.pmic_gpio_enable  = 0,
	.sensor_reset   = GPIO_BACK_CAM_5MP_RESET,
	.sensor_pwd     = GPIO_BACK_CAM_5MP_PWDN,
	.pdata                  = &msm_camera_device_data_csi1[0],
...
#endif
#ifdef CONFIG_JT8EV5
//ECID:0000 zhangzhao 2012-4-23 modified for camera end
static struct msm_camera_sensor_flash_data flash_jt8ev5 = {
    	.flash_type             = MSM_CAMERA_FLASH_LED,
    	.flash_src              = &msm_zte_flash_src,
	//.flash_type             =MSM_CAMERA_FLASH_NONE,// MSM_CAMERA_FLASH_LED,
	//.flash_src              = &msm_flash_src
...
static struct msm_camera_sensor_platform_info sensor_board_info_jt8ev5 = {
	.mount_angle	= 90,
	//.cam_vreg = msm_cam_vreg,
	//.num_vreg = ARRAY_SIZE(msm_cam_vreg),
	.gpio_conf = &gpio_conf_jt8ev5,
};


static struct msm_camera_sensor_info msm_camera_sensor_jt8ev5_data = {
	.sensor_name    = "jt8ev5",
	.sensor_reset_enable = 1,
	.pmic_gpio_enable    = 0,
	.sensor_reset   = GPIO_BACK_CAM_5MP_RESET,
	.sensor_pwd     = GPIO_BACK_CAM_5MP_PWDN,
	.pdata                  = &msm_camera_device_data_csi1[0],
	.flash_data             = &flash_jt8ev5,
	.sensor_platform_info   = &sensor_board_info_jt8ev5,
	.csi_if                 = 1,
	.camera_type = BACK_CAMERA_2D,
	.sensor_type = YUV_SENSOR,
};
...
static struct msm_camera_sensor_platform_info sensor_board_info_mt9d115 = {
	...
	//.cam_vreg = msm_cam_vreg,
	//.num_vreg = ARRAY_SIZE(msm_cam_vreg),
	.gpio_conf = &gpio_conf_mt9d115,
};
static struct msm_camera_sensor_info msm_camera_sensor_mt9d115_data = {
	.sensor_name    = "mt9d115",
	.sensor_reset_enable = 1,
	.pmic_gpio_enable    = 0,
	.sensor_reset   = GPIO_BACK_CAM_RESET,
	.sensor_pwd     = GPIO_BACK_CAM_PWDN,
	.pdata                  = &msm_camera_device_data_csi1[0],
	...
	.camera_type = BACK_CAMERA_2D,
	.sensor_type = YUV_SENSOR,
    .autofocus_info = 1, //zte-modify jixd 20121212 add for back camera not support auto focus
};
#endif
/*ZTEBSP yuxin add for hynix RAW sensor Hi-542 2012.05.31 ++*/
#ifdef CONFIG_HI542
/*ZTEBSP yuxin add for hi542 using DW9714A driver VCM,2012.07.13 ++*/
static struct i2c_board_info hi542_actuator_i2c_info = {
	I2C_BOARD_INFO("msm_actuator", 0x18),
};

static struct msm_actuator_info hi542_actuator_info = {
	.board_info     = &hi542_actuator_i2c_info,
	.cam_name   = MSM_ACTUATOR_MAIN_CAM_1,// the same with the cam_name in af_main_cam_*.h(vendor),yuxin modify 
	.bus_id         = MSM_GSBI0_QUP_I2C_BUS_ID,
	.vcm_pwd        = 0,
	.vcm_enable     = 0,
};
...
static struct msm_camera_sensor_info msm_camera_sensor_hi542_data = {
	...
	.camera_type = BACK_CAMERA_2D,
	.sensor_type = BAYER_SENSOR,
	.actuator_info = &hi542_actuator_info,/*ZTEBSP yuxin add for hi542 using DW9714A driver VCM,2012.07.13 */
...
static void __init msm7x27a_init_cam(void)
{
	if (!(machine_is_msm7x27a_ffa() || machine_is_msm7625a_ffa()
		...
		//ZTEBSP yuxin add CONFIG to control the code,2012.09.20 ++
		#ifdef CONFIG_S5K4E1
	...
	if (machine_is_msm8625_evb()
		...
		sensor_board_info_ov7692.cam_vreg =
			NULL;//ov7692_gpio_vreg;
		sensor_board_info_ov7692.num_vreg =
			0;//ARRAY_SIZE(ov7692_gpio_vreg);
		#endif
		#ifdef CONFIG_OV5647
...
//ECID:0000 zhangzhao 2012-4-23 modified for camera start
       #ifdef CONFIG_OV5640
	{//zhangzhao
		I2C_BOARD_INFO("ov5640", 0x78>> 1),//0x3c
		.platform_data = &msm_camera_sensor_ov5640_data,
	},
	#endif
	#ifdef CONFIG_S5K5CA
	{//zhangzhao
		I2C_BOARD_INFO("s5k5ca", 0x5a),//0x5a
		.platform_data = &msm_camera_sensor_s5k5ca_data,
	},
	#endif
	#ifdef CONFIG_JT8EV5
	{//DangXiao for T8EV5
		I2C_BOARD_INFO("jt8ev5", 0x78>>2),//0x5a ->0x78
		.platform_data = &msm_camera_sensor_jt8ev5_data,
	},
	#endif
	#ifdef CONFIG_MT9D115
	{
		I2C_BOARD_INFO("mt9d115", 0x7A),//0x5a ->0x78
...
/*ZTEBSP yuxin add for P865e02 PRJ sensors,ov2675 and sp0a28,2012.10.19--*/
...

	{
       ...
       /*ZTEBSP yuxin add for P825A10 use flash chip adp1655,2012.05.10 ++*/
       #ifdef CONFIG_ZTE_CAMERA_SOC_FLASH
       {
		I2C_BOARD_INFO("adp1655", 0x60>>1),  //flash chip adp1655
	},
       #endif
       /*ZTEBSP yuxin add for P825A10 use flash chip adp1655,2012.05.10 --*/
};
...
{
/*ZTEBSP yuxin modify for init GPIOs,2012.09.20 ++*/
#ifdef CONFIG_PROJECT_V72A 
   /*In this function , only need to init the GPIOs which the 2 cameras share,
   like extenal LDO En pins, Mclk switch pin. The camera's own EN pins are init in the sensor driver code*/
	...
	gpio_tlmm_config(GPIO_CFG(
				GPIO_CAMERA_2V8_AVDD_EN,
				0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);

/*	gpio_tlmm_config(GPIO_CFG(
				GPIO_CAMERA_1V8_DVDD_EN,
				0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);*/
...
#ifndef CONFIG_MSM_CAMERA_V4L2
#define LCD_CAMERA_LDO_2V8 58 /* SKU1&SKU3 2.8V LDO */
...
void __init msm7627a_camera_init(void)
{
	...
	if (machine_is_msm7627a_qrd3() || machine_is_msm8625_qrd7()) {
		#if 0  //yuxin del Qualcomm org code
	...
	if (machine_is_msm7627a_evb() || machine_is_msm8625_evb()
	        ||machine_is_msm8625_surf()    //zhangzhao
			|| machine_is_msm8625_evt()
		...
		evb_camera_gpio_cfg();
	       ...
	       pr_err("%s: camera_power_init successed.\n", __func__);	
	}
	...
	if ((!machine_is_msm7627a_qrd1() || !machine_is_msm7627a_evb()
					...
					|| !machine_is_msm8625_evt()
					|| !machine_is_msm7627a_qrd3()
					|| !machine_is_msm8625_qrd7())&&(!machine_is_msm8625_surf() ))
