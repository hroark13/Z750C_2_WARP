...
#ifdef CONFIG_ZTE_PLATFORM  //added by shiyan 
extern void msm_batt_force_update(void);//shiyan added
#endif
...
static void report_hs_key(uint32_t key_code, uint32_t key_parm)
{
	...
	case KEY_VOLUMEUP:
	case KEY_VOLUMEDOWN:
//[ECID:000000] ZTEBSP wanghaifei 20120710, add power key dump for debug
...
//[ECID:000000] ZTEBSP  lichuangchuang mod for headset 20120420 start
	case MSM_MIC:
		return sprintf(buf, "Headset\n");
//[ECID:000000] ZTEBSP  lichuangchuang mod for headset 20120420 end
	}
	return -EINVAL;
}
