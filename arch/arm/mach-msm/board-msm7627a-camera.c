...
#ifdef CONFIG_PROJECT_P825A10
  #ifdef CONFIG_OV5647
    #undef CONFIG_OV5647
  #endif
#endif

#ifdef CONFIG_MSM_CAMERA_V4L2 //ECID:0000 zhangzhao 2012-4-23 modified for camera
#define GPIO_SKU1_CAM_VGA_SHDN    39 //zhangzhao 18
//#define GPIO_SKU1_CAM_VGA_RESET_N 29  //zhangzhao
#define GPIO_SKU3_CAM_5MP_SHDN_N   42 //zhangzhao 5         /* PWDN */
#define GPIO_SKU3_CAM_5MP_CAMIF_RESET   27 //zhangzhao 6    /* (board_is(EVT))?123:121 RESET */
...
#ifdef CONFIG_OV5640//ECID:0000 zhangzhao 2012-4-23 modified for camera 5640
...
//#ifdef CONFIG_MSM_CAMERA_FLASH  //yuxin modify for compile 2012.08.29
#ifndef CONFIG_MSM_CAMERA_FLASH
...
//ECID:0000 zhangzhao 2012-4-23 modified for camera
#ifdef CONFIG_MSM_CAMERA_V4L2//zhangzhao
static struct regulator_bulk_data regs_camera[] = {
	{ .supply = "msme1", .min_uV = 1800000, .max_uV = 1800000 },
	{ .supply = "wlan4",   .min_uV = 2800000, .max_uV = 2800000 },
};
#if 0  //yuxin del 2012.08.29
static struct camera_vreg_t msm_cam_vreg[] = {
	{"msme1", REG_LDO, 1800000, 1800000, 0},
	{"wlan4", REG_LDO, 2850000, 2850000, 0},
...
static struct msm_actuator_info msm_act_main_cam_5_info = {
	...
	.bus_id         = MSM_GSBI0_QUP_I2C_BUS_ID,
	//.vcm_pwd        = GPIO_SKU3_CAM_5MP_CAM_DRIVER_PWDN,//ECID:0000 zhangzhao 2012-4-23 modified for camera no this pin
	.vcm_enable     = 1,
};
...
static struct msm_actuator_info msm_act_main_cam_3_info = {
	...
	.bus_id         = MSM_GSBI0_QUP_I2C_BUS_ID,
//	.vcm_pwd        = GPIO_SKU3_CAM_5MP_CAM_DRIVER_PWDN, //wanghaifei for JB
	.vcm_enable     = 0,
};
...
static struct msm_camera_sensor_flash_src msm_flash_src_b20 = {
	.flash_sr_type = MSM_CAMERA_FLASH_SRC_LED1,
...
#ifdef CONFIG_OV5640
	{//zhangzhao
		I2C_BOARD_INFO("ov5640", 0x78),//0x3c
		.platform_data = &msm_camera_sensor_ov5640_data,
	},
#endif
#ifdef CONFIG_S5K5CA
	{//zhangzhao
		I2C_BOARD_INFO("s5k5ca", 0x5a>>1),//0x5a
...
#else
#if 0//ECID:0000 zhangzhao 2012-4-23 modified for camera code no use
...
#endif
#endif//ECID:0000 zhangzhao 2012-4-23 modified for camera code no use
...
//ECID:0000 zhangzhao 2012-4-23 modified for camera code no use
#if 0 //#ifndef CONFIG_MSM_CAMERA_V4L2
...
#endif//ECID:0000 zhangzhao 2012-4-23 modified for camera end
...
void __init msm7627a_camera_init(void)
{
	...
	if (machine_is_msm7627a_evb() || machine_is_msm8625_evb()
			...
			|| machine_is_msm8625_qrd7()) {
#ifndef CONFIG_MSM_CAMERA_V4L2
		//lcd_camera_power_init();  ////ECID:0000 zhangzhao 2012-4-23 modified for camera
#endif
		evb_camera_gpio_cfg();
	}
...
#else////ECID:0000 zhangzhao 2012-4-23 modified for camera 
	rc = regulator_bulk_get(NULL, ARRAY_SIZE(regs_camera), regs_camera);
	...
	rc =regulator_bulk_enable(ARRAY_SIZE(regs_camera), regs_camera);
	if (rc) {
		pr_err("%s: could not enable voltages: %d\n", __func__, rc);
		return;
	}

	pr_info("regulator_bulk_enabled ++++++++++++++\n");
