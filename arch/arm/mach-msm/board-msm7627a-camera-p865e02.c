...
#define GPIO_FRONT_CAM_RESET                   122  //front cam RESET pin 
#define GPIO_BACK_CAM_PWDN                      13    //back cam PWDN pin 
#define GPIO_BACK_CAM_RESET                     123  //back cam RESET pin 
//cam power supply LDO En GPIO pins
#define GPIO_CAMERA_2V8_AVDD_EN                 35   //AVDD 2.8V LDO EN pin
#define GPIO_CAMERA_1V8_DVDD_EN               120   //DVDD AND IOVDD 1.8V LDO EN pin
...
#ifdef CONFIG_PROJECT_P865E02//yuxin
